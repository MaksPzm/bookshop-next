            ...
            {dataBook.items.map((book: Book) => (
                <div key={book.id} id={`${book.id}`} className={styles.book}>
                    ...
                    <div className={styles.blockDescription}>
                        ...
                        <span className={`${styles.blockDescription__text} ${styles.blockDescription__review}`}>{book.volumeInfo.maturityRating === "NOT_MATURE" ? `` : `${book.volumeInfo.maturityRating} review`}</span>
